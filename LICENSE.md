# BeyondPlay (Arena) — Proprietary License
...
Open-source libraries bundled or depended on (for example Laravel and other
PHP/JS packages) remain under **their own licenses**. Those licenses do **not**
grant any rights to the original BeyondPlay / Arena application code, design,
markup, branding, API, or documentation in this repository.

See `tournament-backend/composer.lock` for PHP dependency licenses.

## Contact

Licensing or collaboration: [github.com/raiyanibnekamal](https://github.com/raiyanibnekamal)
